...
export const Scene13: React.FC = () => (
  <SlideLayout avatarImage="레팬3.png">
    ...
    <FadeText delay={15} duration={22}>
      ...
      >
        <div style={{ fontSize: 32, fontFamily: FONT, color: COLORS.blue, fontWeight: 700, marginBottom: 10 }}>
          부모가 모든 일을 대신해주면
        </div>
    ...
    <FadeText delay={38} duration={22}>
      ...
      >
        ...
        <div style={{ fontSize: 32, fontFamily: FONT, fontWeight: 700, color: COLORS.topBar }}>
          몸도 똑같은 원리
        </div>
      </div>
    </FadeText>
