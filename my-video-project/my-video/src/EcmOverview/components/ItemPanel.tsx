...
export const MOK_PANELS: Record<string, ItemPanelProps> = {
  ...
  '3d': {
    ...
    points: [
      ...
      // 유보 문장("보편적 경향일 뿐…")은 화면에서 제거(2026-09-06 원장님 검수)
      // — 내레이션(tts v7 172행)이 전달하고, 화면은 career 배지가 상시 담당
  ...
  '4d': {
    ...
    points: [
      ...
      { text: '술과 거리가 있는 일' },
      // v6 46항 — "나무와 불" 포인트 삭제. 유보 문장("경향성일 뿐…")도
      // 화면에서 제거(2026-09-06 원장님 검수) — 내레이션(tts v7 210행)이 전달
      { text: '교육계 · 기계공학' },
    ],
  },
  '4e': {
