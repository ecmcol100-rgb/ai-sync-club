 ...
 * / 수양 진한 주황 / 수음 연한 주황.
 *
 * 칩 적용 기준(원장님 확정, 2026-09-06): "제목·도입·마무리에서 체질을
 * 소개하는 자리에만". 본문 서술 중 체질명이 스쳐 지나가는 경우에는 쓰지
 * 않는다 — 기본 텍스트로. 칩이 남발되면 강조 기능이 사라진다.
 * 목·목음편 사용처(참고, 7곳): 편 타이틀 / 섹션 2 도입 / 체질 타이틀 카드 /
 * 대조표 헤더 / 인물 카드 / 4-i 질문 화면 / 클로징 마무리.
 * ※ 목록은 참고용 — 늘어나도 규칙 위반이 아니며 판단은 기준으로 한다.
 *
